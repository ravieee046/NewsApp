    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.log_out:
                ...
                editor.putString(getResources().getString(R.string.key_email_id), "");
                editor.putString(getResources().getString(R.string.key_password), "");
                editor.apply();

                Intent intent = new Intent(NewsStoryMainActivity.this, LoginActivity.class);
